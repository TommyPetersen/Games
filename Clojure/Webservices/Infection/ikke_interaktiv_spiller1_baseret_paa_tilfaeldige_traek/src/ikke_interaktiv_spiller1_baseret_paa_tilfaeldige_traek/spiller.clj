(ns ikke-interaktiv-spiller1-baseret-paa-tilfaeldige-traek.spiller
  (:require [org.httpkit.server :as server]
	    ...
	    [games.infection.ikke-interaktiv-spiller-baseret-paa-tilfaeldige-traek :as ikke-interaktiv-spiller-baseret-paa-tilfaeldige-traek]
  )
  (:gen-class)
)
...
(defroutes app-routes
  (GET "/" [] "Dette er en ikke-interaktiv spiller1 til spillet \"Infektion\".")
